...
import SellForm from '../components/ProductComponents/SellForm.jsx';
                ...
                <div className="relative max-w-3xl mx-auto px-4 sm:px-6">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-sm sm:text-base text-gray-500 mt-2 leading-relaxed max-w-lg">
                            List your product in minutes. Add clear photos, set a fair price, and reach thousands of buyers.
                        </p>
                    </div>
